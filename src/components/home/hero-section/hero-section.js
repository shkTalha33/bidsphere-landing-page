        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 z-50 flex flex-col items-center justify-center text-center text-white px-4">
              ...
              <motion.button variants={bounce} className="bg-white text-black px-12 py-2 md:py-3 rounded-md sm:text-lg font-semibold hover:bg-gray-100 transition-colors">
                Bid Now
              </motion.button>
            </div>
          </div>
