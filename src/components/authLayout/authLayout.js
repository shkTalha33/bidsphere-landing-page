    ...
    <section className="bg-white relative max-w-[1800px] w-100 h-screen mx-auto min-[3057px]:h-[70rem]">
      <div className="flex h-100">
        ...
        >
          <div className="flex absolute h-screen items-center justify-center gap-2 w-full">
            <div className="flex flex-col gap-2 max-w-md w-full">
              ...
              <p className="text-white poppins_regular text-lg">
                {description}
              </p>
            </div>
          </div>
        ...
        <main
          ...
          }  flex w-full min-[1440px]:max-w-[45%] md:max-w-[603px] md:overflow-auto w-100 py-3 px-md-5 px-3 h-100 mx-md-0 mx-auto`}
        >
