...
const RegistrationDetail = () => {
  ...
  return (
    <>
      ...
      <Container className="bg_white rounded-[9px] mt-4 p-4 shadow-[0px_4px_22.9px_0px_#0000000D]">
        <Row>
          <Col md="12" className="">
            <h3 className="capitalize poppins_semibold text-2xl text_dark mb-[10px]">
              personal information
            </h3>
            <h3 className="capitalize poppins_regular text-lg text_secondary2">
              enter required information here
            </h3>
          </Col>
          <Col md="12" className="mt-4">
            <h3 className="capitalize poppins_regular text-xl text-[#8D8D8D] mb-[10px]">
              Your progress
            </h3>
            <h3 className="capitalize poppins_regular text-lg text_primary mb-2">
              {progress}% to complete
            </h3>
            <div className="">
            <Progress percent={progress} strokeColor={"#21CD9D"}  size={['100%', 16]} showInfo={false} />
            </div>
          </Col>
        </Row>
      </Container>
