    ...
    <>
      <Col md="12">
        <div className="flex justify-center items-center gap-1 mb-[18px]">
          ...
          <p className="text-[#202020] inter_semibold text-2xl text-center capitalize">
            {title}
          </p>
        </div>
      </Col>
      <Col md="12">
        <h4 className="text_darkprimary text-5xl text-center capitalize">{heading1} {" "} <span className="text_primary capitalize">{heading2}</span></h4>
