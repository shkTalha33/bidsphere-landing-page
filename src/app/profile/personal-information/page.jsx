                ...
                <div className="w-full flex flex-col items-start gap-3 lg:w-3/4">
                    <div className="w-full bg-white p-4 flex justify-between items-center rounded-lg shadow-sm">
                        <div className="flex flex-col w-full">
                            <h1 className="text-2xl poppins_semibold">Personal information</h1>
                        ...
                        <div className="flex justify-between items-start mb-8">
                            <div className="flex flex-col md:flex-row items-start w-full">
                                <div className="w-full md:w-1/2">
                                    <h2 className="text-2xl poppins_semibold mb-2">Profile Photo</h2>
                                ...
                                <div className="w-full md:w-1/2 flex items-center gap-6 mt-6 md:mt-0">
                                    ...
                                    >
                                        ...
                                        <p className="text-green-500 font-medium">Click to replace</p>
                                        <p className="text-gray-500 text-sm mt-1">or drag and drop</p>
                                        <p className="text-gray-400 text-xs mt-1">SVG, PNG, JPG or GIF (max. 400 x 400px)</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="flex flex-col md:flex-row">
                                    <div className="w-full md:w-1/2 mb-6 md:mb-0">
                                        <h2 className="text-2xl poppins_semibold mb-2">Personal information</h2>
                                        <p className="text-gray-700 poppins_medium">
                                            This info will be shown publicly as your personal information.
                                        </p>
                                    </div>
                                    <div className="w-full md:w-1/2 space-y-6">
                                        <div>
                                            <h3 className="font-medium text-gray-700 poppins_medium">Full Name</h3>
                                            {isEditing ? (
                                                <div>
                                                    <input
                                                        type="text"
                                                        ...
                                                        className={`w-full p-2 border rounded mt-1 ${formErrors.fullName ? 'border-red-500' : 'border-gray-300'}`}
                                                    />
                                                    {formErrors.fullName && (
                                                ...
                                                <p className="text-gray-900 poppins_regular">{profileData.fullName}</p>
                                            )}
                                        </div>
                                        <div>
                                            <h3 className="font-medium text-gray-700 poppins_medium">Date of Birth</h3>
                                            {isEditing ? (
                                                <div>
                                                    <input
                                                        type="date"
                                                        ...
                                                        onChange={handleInputChange}
                                                        className={`w-full p-2 border rounded mt-1 ${formErrors.dateOfBirth ? 'border-red-500' : 'border-gray-300'}`}
                                                    />
                                                ...
                                                <p className="text-gray-900 poppins_regular">
                                                    {formatDate(profileData.dateOfBirth)} {calculateAge(profileData.dateOfBirth)}
                                                </p>
                                            )}
                                        </div>
                                        <div>
                                            <h3 className="font-medium text-gray-700 poppins_medium">Phone Number</h3>
                                            {isEditing ? (
                                                <div>
                                                    <input
                                                        type="tel"
                                                        ...
                                                        onChange={handleInputChange}
                                                        className={`w-full p-2 border rounded mt-1 ${formErrors.phoneNumber ? 'border-red-500' : 'border-gray-300'}`}
                                                    />
                                                ...
                                                <p className="text-gray-900 poppins_regular">{profileData.phoneNumber}</p>
                                            )}
                                        </div>
                                        <div>
                                            <h3 className="font-medium text-gray-700 poppins_medium">Email</h3>
                                            {isEditing ? (
                                                <div>
                                                    <input
                                                        type="email"
                                                ...
                                                <p className="text-gray-900 poppins_regular">{profileData.email}</p>
                                            )}
                                        </div>
