...
const OrderSummary = ({ orderDetail }) => {
  ...
  return (
    <div className="rounded-lg">
      <h2 className="text-base sm:text-lg capitalize poppins_semibold text-gray-800 mb-3">
        {t("order.heading16")}
      </h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2">
        <div>
          <p className="text-sm text-gray-500 mb-1">{t("order.heading19")}</p>
        ...
        <div>
          <p className="text-sm text-gray-500 mb-1">{t("order.heading34")}</p>
          <p className="text-base poppins_medium text-gray-800">
            {user?.email}
          </p>
        </div>
        <div>
          <p className="text-sm text-gray-500 mb-1">{t("order.heading35")}</p>
          <p className="text-base poppins_medium text-gray-800">
            {user?.phone}
          </p>
        </div>
        <div>
          <p className="text-sm text-gray-500 mb-1">{t("order.heading20")}</p>
          <p className="text-base poppins_medium text-gray-800">{lot?.name}</p>
        </div>
        <div>
          <p className="text-sm text-gray-500 mb-1">{t("order.heading21")}</p>
          <p className="text-base poppins_medium text-gray-800">
        ...
        <div>
          <p className="text-sm text-gray-500 mb-1">{t("order.heading37")}</p>
        ...
        <div>
          <p className="text-sm text-gray-500 mb-1">{t("order.heading22")}</p>
